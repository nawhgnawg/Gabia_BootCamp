...
public class ContentsProc implements ContentsProcInter {
    ...
    public ArrayList<ContentsVO> list_by_categoryno(int categoryno) {
        return contentsDAO.list_by_categoryno(categoryno);
    }
    ...
    public ArrayList<ContentsVO> list_by_categoryno_search_paging(HashMap<String, Object> map) {
        ...
        return contentsDAO.list_by_categoryno_search_paging(map);
    }
...
//
//  <DIV id='paging'>
//    <span class='span_box_1'><A href='list_by_categoryno.do?word=&now_page=1&categoryno=4'>1</A></span>
//  <span class='span_box_2'>2</span>
//  <span class='span_box_1'><A href='list_by_categoryno.do?word=&now_page=3&categoryno=4'>3</A></span>
//    </DIV>
//  </DIV>
//  <!-- 페이지 목록 출력 부분 종료 -->
...
//    str.append("현재 페이지: " + nowPage + " / " + totalPage + "  ");
    ...
    public int password_check(HashMap<String, Object> map) {
        ...
        return contentsDAO.password_check(map);
    }
    ...
    public int update_file(ContentsVO contentsVO) {
        return contentsDAO.update_file(contentsVO);
    }
    ...
    public int count_by_categoryno(int categoryno) {
        return contentsDAO.count_by_categoryno(categoryno);
    }

    @Override
    public int delete_by_categoryno(int categoryno) {
        return contentsDAO.delete_by_categoryno(categoryno);
    }

    @Override
    public int count_by_userno(int userno) {
        return contentsDAO.count_by_userno(userno);
    }

    @Override
    public int delete_by_userno(int userno) {
        return contentsDAO.delete_by_userno(userno);
    }

    @Override
    public int increaseReplycnt(int contentsno) {
        return contentsDAO.increaseReplycnt(contentsno);
    }
