...
public class CateCont {
    ...
    private final String list_file_name = "/cate/list_search";
...
//            return "redirect:/cate/update/" + cateVO.getCateno() + "?word=" + word; // 한글 깨짐 오류
     ...
     * http://localhost:9091/cate/delete/1
     */
    @PostMapping("/delete_all_by_cateno/{cateno}")
    public String delete_all_by_cateno(Model model, @PathVariable("cateno") int cateno,
                                 @RequestParam(name = "word", defaultValue = "") String word,
                                 @RequestParam(name="now_page", defaultValue="1") int now_page,
                                 RedirectAttributes ra) {
